...
public class VideoHelper {
    public static Object[] grabScreenshots(String videoFilePath, int maxFrames) throws IOException, JCodecException {
        ...
        long frameCount = org.jcodec.containers.mp4.MP4Util.parseMovie(videoFile).getVideoTrack().getFrameCount();
